...
wget -P package/openwrt-passwall-packages/shadowsocksr-libev/patches https://raw.githubusercontent.com/sbwml/openwrt_helloworld/v5/shadowsocksr-libev/patches/104-pointer-used-after-free.patch
