...
# btrfs-progs
sed -i 's/PKG_VERSION:=.*/PKG_VERSION:=5.19.1/g' feeds/packages/utils/btrfs-progs/Makefile
sed -i 's/PKG_HASH:=.*/PKG_HASH:=26429e540343ccc7f5d4b3f8f42b916713280e898c5471da705026ef6d2c10a6/g' feeds/packages/utils/btrfs-progs/Makefile
...
sed -i 's/GO_VERSION_PATCH:=.*/GO_VERSION_PATCH:=1/g' feeds/packages/lang/golang/golang/Makefile
sed -i 's/PKG_HASH:=.*/PKG_HASH:=27871baa490f3401414ad793fba49086f6c855b1c584385ed7771e1204c7e179/g' feeds/packages/lang/golang/golang/Makefile
...
# docker-compose
sed -i 's/PKG_VERSION:=.*/PKG_VERSION:=2.11.0/g' feeds/packages/utils/docker-compose/Makefile
sed -i 's/PKG_HASH:=.*/PKG_HASH:=fe01c85ad31767c22d5f6ea24e6809f5b675c9253d534138ee4095428dfcb96a/g' feeds/packages/utils/docker-compose/Makefile
...
sed -i 's/PKG_SOURCE_VERSION:=.*/PKG_SOURCE_VERSION:=33ead3afbdf7d2bcf124da6cb48d46124703a7b2/g' feeds/packages/net/smartdns/Makefile
...
# haproxy
sed -i 's/PKG_VERSION:=.*/PKG_VERSION:=2.6.5/g' feeds/packages/net/haproxy/Makefile
sed -i 's/PKG_RELEASE:=.*/PKG_RELEASE:=1/g' feeds/packages/net/haproxy/Makefile
sed -i 's/PKG_HASH:=.*/PKG_HASH:=ce9e19ebfcdd43e51af8a6090f1df8d512d972ddf742fa648a643bbb19056605/g' feeds/packages/net/haproxy/Makefile
sed -i 's/BASE_TAG:=.*/BASE_TAG=v2.6.5/g' feeds/packages/net/haproxy/get-latest-patches.sh
...
# tailscale
sed -i 's/PKG_VERSION:=.*/PKG_VERSION:=1.30.2/g' feeds/packages/net/tailscale/Makefile
sed -i 's/PKG_HASH:=.*/PKG_HASH:=4e5ee37ae734b8312153d4f8da340295e9a6a455e3f3943a62199b16d89c8bb5/g' feeds/packages/net/tailscale/Makefile
...
# nghttp2
sed -i 's/PKG_VERSION:=.*/PKG_VERSION:=1.49.0/g' feeds/packages/libs/nghttp2/Makefile
sed -i 's/PKG_HASH:=.*/PKG_HASH:=b0cfd492bbf0b131c472e8f6501c9f4ee82b51b68130f47b278c0b7c9848a66e/g' feeds/packages/libs/nghttp2/Makefile
...
# xz
sed -i 's/PKG_VERSION:=.*/PKG_VERSION:=5.2.6/g' feeds/packages/utils/xz/Makefile
